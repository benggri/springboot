package com.benggri.springboot.config.swagger;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.OAS_30).securityContexts(Arrays.asList(securityContext()))
                                                   ...
                                                   .select()
                                                   .apis(RequestHandlerSelectors.basePackage("com.benggri.springboot"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Spring Boot Study")
                                   .description("Spring Boot Study Swagger")
                                   .version("1.0")
                                   .build();
    }
